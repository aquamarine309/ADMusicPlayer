...
createInCategory(Note, "D", /d/i, {
  $autocomplete: "d",
  $pitch: 2
});

createInCategory(Note, "E", /e/i, {
  $autocomplete: "e",
  $pitch: 4
});

createInCategory(Note, "F", /f/i, {
  $autocomplete: "f",
  $pitch: 5
});

createInCategory(Note, "G", /g/i, {
  $autocomplete: "g",
  $pitch: 7
});

createInCategory(Note, "A", /a/i, {
  $autocomplete: "a",
  $pitch: 9
});

createInCategory(Note, "B", /b/i, {
  $autocomplete: "b",
  $pitch: 11
});
