import { lexer, tokenMap as T } from "./lexer.js";
...
class Validator extends BaseVisitor {
  ...
  musicNote(ctx) {
    ...
    if (ctx.NoteLiteral) {
      ...
      octave = parseFloat(ctx.NumberLiteral[0].image);
      pitch = ctx.Note[0].tokenType.$pitch;
      offset = 0;
    }
    const value = octave * 12 + pitch + offset - 48;
